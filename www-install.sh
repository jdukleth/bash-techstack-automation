...
system "ADDMSGD MSGID(USR0003) MSGF(WWWMENU/WWWMNU1) MSG('SBMJOB CMD(QSH CMD(''/QOpenSys/pkgs/bin/nginx -s reload'')) JOBQ(QUSRNOMAX) ALWMLTTHD(*YES) USER($I_NGINX_USER)')"
system "ADDMSGD MSGID(USR0004) MSGF(WWWMENU/WWWMNU1) MSG('SBMJOB CMD(QSH CMD(''/QOpenSys/pkgs/bin/nginx'')) JOBQ(QUSRNOMAX) ALWMLTTHD(*YES) USER($I_NGINX_USER)')"
system "ADDMSGD MSGID(USR0005) MSGF(WWWMENU/WWWMNU1) MSG('SBMJOB CMD(QSH CMD(''/QOpenSys/pkgs/bin/nginx -s stop'')) JOBQ(QUSRNOMAX) USER($I_NGINX_USER)')"
...
system "ADDMSGD MSGID(USR0010) MSGF(WWWMENU/WWWMNU1) MSG('SBMJOB CMD(QSH CMD(''/QOpenSys/pkgs/sbin/php-fpm'')) JOBQ(QUSRNOMAX) ALWMLTTHD(*YES) USER($I_PHPFPM_USER)')"
