...
system "ADDMSGD MSGID(USR0010) MSGF(WWWMENU/WWWMNU1) MSG('SBMJOB CMD(QSH CMD(''/QOpenSys/pkgs/sbin/php-fpm'')) JOBQ(QUSRNOMAX) ALWMLTTHD(*YES) USER($I_PHPFPM_USER) INLLIBL(*JOBD)')"
