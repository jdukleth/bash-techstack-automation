...
system "ADDMSGD MSGID(USR0004) MSGF(WWWMENU/WWWMNU1) MSG('SBMJOB CMD(QSH CMD(''/QOpenSys/pkgs/bin/nginx'')) ALWMLTTHD(*YES) USER($I_NGINX_USER)')"
...
system "ADDMSGD MSGID(USR0010) MSGF(WWWMENU/WWWMNU1) MSG('SBMJOB CMD(QSH CMD(''/QOpenSys/pkgs/sbin/php-fpm'')) ALWMLTTHD(*YES) USER($I_PHPFPM_USER)')"
